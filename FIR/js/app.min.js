...
function errorout() {
    $.smallBox({
        title: "Sorry! Encountered critical error, refreshing page ! ",
        content: "<i class='fa fa-clock-o'></i> <i>" + JSON.stringify(xhr) + "</i>",
        color: "#FF0000",
        iconSmall: "fa fa-check bounce animated",
        timeout: 2000
    });
    loadContent("/Home/Dashboard");
}
...
$.throttle_delay = 350, $.menu_speed = 235, $.navAsAjax = !0, $.enableJarvisWidgets = !0, $.enableMobileWidgets = !1, $.fastClick = !1, $.calc_navbar_height = function () {
    var a = null;
    c = $("#header").length && (a = $("#header").height()), null === a && (a = $('<div id="header"></div>').height()), null === a ? 49 : a
    return (c < 350) ? 350 : c;

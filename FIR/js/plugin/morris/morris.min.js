(function () {
    ...
    t = window.Morris = {}, e = jQuery, t.EventEmitter = function () {
        ...
        return o(r, n), r.prototype.gridDefaults = {
            ...
            if (this.elementWidth !== i || this.elementHeight !== n || this.dirty) {
                this.elementWidth = i, this.elementHeight = n, this.dirty = !1, this.left = this.options.padding, this.right = this.elementWidth - this.options.padding, this.top = this.options.padding, this.bottom = this.elementHeight - this.options.padding, this.options.axes && (s = function () {
                    var e, n, r, i;
                    r = this.grid, i = [];
                    for (e = 0, n = r.length; e < n; e++) t = r[e], i.push(this.measureText(this.yAxisFormat(t), this.options.gridTextSize).width);
                    return i
                }.call(this), this.left += Math.max.apply(Math, s), this.options.xLabelsDiagonal ? (e = function () {
                    var e, t, n;
                    n = [];
                    for (r = e = 0, t = this.data.length; 0 <= t ? e < t : e > t; r = 0 <= t ? ++e : --e) n.push(this.measureText(this.data[r].text, this.options.gridTextSize, -90).height);
                    return n
                }.call(this), this.maxXLabelHeight = Math.max.apply(Math, e), this.bottom -= this.maxXLabelHeight) : this.bottom -= 1.5 * this.options.gridTextSize), this.width = Math.max(1, this.right - this.left), this.height = Math.max(1, this.bottom - this.top), this.dx = this.width / (this.xmax - this.xmin), this.dy = this.height / (this.ymax - this.ymin);
        ...
        }, r.prototype.measureText = function (e, t, n) {
            var r, i;
            return t == null && (t = 12), n == null && (n = 0), i = this.raphael.text(100, 100, e).attr("font-size", t).rotate(n), r = i.getBBox(), i.remove(), r
        ...
        return o(n, e), n.prototype.init = function () {
            ...
            o = this.bottom + this.options.gridTextSize * 1.25, i = null, e = function (e, t) {
                var n, r;
                return n = l.drawXAxisLabel(l.transX(t), o, e), r = n.getBBox(), l.options.xLabelsDiagonal ? n.rotate(-90).translate(-r.height / 2, 0) : (i == null || i >= r.x + r.width) && r.x >= 0 && r.x + r.width < l.el.width() ? i = r.x - l.options.xLabelMargin : n.remove()
        ...
        return o(r, n), r.prototype.init = function () {
            ...
            for (e = o = 0, u = this.data.length; 0 <= u ? o < u : o > u; e = 0 <= u ? ++o : --o) i = this.data[this.data.length - 1 - e], t = this.drawXAxisLabel(i._x, s, i.label), n = t.getBBox(), this.options.xLabelsDiagonal ? a.push(t.rotate(-60).translate(-n.width / 2, 0)) : (r == null || r >= n.x + n.width) && n.x >= 0 && n.x + n.width < this.el.width() ? a.push(r = n.x - this.options.xLabelMargin) : a.push(t.remove());
            return a
